...
contract Entropy {
	...
	function mint(address dst, uint256 rawAmount) external {
		...
		require(amount <= (totalSupply * mintCap) / 100, "Erp::mint: exceeded mint cap");
		totalSupply = safe96(totalSupply + amount, "Erp::mint: totalSupply exceeds 96 bits");
	...
	function permit(
		...
		require(block.timestamp <= deadline, "Erp::permit: signature expired");
	...
	function delegateBySig(
		...
		require(block.timestamp <= expiry, "Erp::delegateBySig: signature expired");
