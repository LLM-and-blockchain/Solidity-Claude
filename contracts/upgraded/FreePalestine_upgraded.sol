...
// ----------------------------------------------------------------------------
// Safe maths - not needed in 0.8.x as overflow checking is built-in,
// but keeping the contract structure identical
// ----------------------------------------------------------------------------
contract SafeMath {
...
contract FreePalestine is ERC20Interface, Owned, SafeMath {
    ...
    constructor() {
        ...
        // In 0.8.x, we need to use the full address syntax with the proper checksum
    ...
    // ------------------------------------------------------------------------
    // Don't accept ETH - commented out in original, kept commented out here
    // ------------------------------------------------------------------------
